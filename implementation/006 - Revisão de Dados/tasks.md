...
- [ ] **T-001:** Montagem dos valores efetivos por seção
...
- [ ] **T-002:** Server Action `setOverride` com auditoria e revalidação
...
- [ ] **T-003:** Componente `FieldRow` por tipo de campo
...
- [ ] **T-004:** Painel de pendências + botão "Confirmar dados"
...
- [ ] **T-005:** Página `/reports/[id]/review`
...
- [ ] **T-006:** Testes de integração das actions
  - **Descrição:** `setOverride` (persistência, auditoria, revalidação, override vazio em required, override igual ao extraído) e `confirmData` (bloqueio com erro, sucesso sem erro).
  - **Arquivos envolvidos:** testes de `apps/web/lib/actions/review.ts`
  - **Critério de conclusão:** Casos de borda da spec §6.4 cobertos.
  - **Dependências:** T-004
  - **Estimativa:** Média

- [ ] **T-007:** E2E — corrigir campo e avançar
